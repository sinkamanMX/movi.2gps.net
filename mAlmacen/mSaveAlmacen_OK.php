...
//			  
//			   $cabecera = 'INSERT INTO ALG_BD_CORPORATE_TEST.PED_ALMACEN_PDI_UNIDAD 
//								(ID_ALMACEN, 
//								ID_PDI, 
//								ID_CLIENTE, 
//								COD_ENTITY)	VALUES';
...
//			     	if($cuerpo == ''){
//			     		if($_GET['pdi_uni']=='1'){
//			     				$cuerpo = '("'.$ultimo_insertado.'","'.$cadenitas2[$k].'","'.$client.'","0")';
//			     		}else{
//			     				$cuerpo = '("'.$ultimo_insertado.'","0","'.$client.'","'.$cadenitas2[$k].'")';
//			     		}
//			     	
//			     	}else{
//			     		
...
//			
			 ...
			 }else{  // si no se han elegido pdi's o unidades solo guardar almacen
			 	 echo 1;
			 }
		}else{
			echo 0;
			  ...
			  // $ultimo_insertado = lastid();
			   ...
			   $cuerpo = '';
			     ...
			     for($k=0;$k<count($cadenitas2);$k++){
			     	if($cuerpo == ''){
			     		if($_GET['pdi_uni']=='1'){
			     				$cuerpo = '("'.$id.'","'.$cadenitas2[$k].'","'.$client.'","0")';
			     		}else{
			     				$cuerpo = '("'.$id.'","0","'.$client.'","'.$cadenitas2[$k].'")';
			     		}
