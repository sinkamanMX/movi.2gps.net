...
$quers1="SELECT
	...
	for($i=0;$i<$count1;$i++){
			...
			$quers2="SELECT 
							...
							$rompe=explode('!',$row2);
							if($cadena_final==' '){
								$cadena_final=$userAdmin->codif($mindata[0]).','.$userAdmin->codif($mindata[1]).','.$mindata[6].','.$correo.','.$mindata[2].','.$mindata[3].','.$mindata[4].','.$rompe[0].','.$mindata[8].','.$rompe[1].','.$mindata[9].','.$mindata[7];
								}else{
								$cadena_final=$cadena_final.'!'.$userAdmin->codif($mindata[0]).','.$userAdmin->codif($mindata[1]).','.$mindata[6].','.$correo.','.$mindata[2].','.$mindata[3].','.$mindata[4].','.$rompe[0].','.$mindata[8].','.$rompe[1].','.$mindata[9].','.$mindata[7];
								}		
				}
