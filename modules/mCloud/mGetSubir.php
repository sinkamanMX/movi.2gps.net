...
if ($_FILES['archivo']["error"] > 0){
    ...
    $moved = move_uploaded_file($_FILES['archivo']['tmp_name'],$utl .'/'. str_replace(" ","_",$_FILES['archivo']['name']));
   ...
   if($moved) {
	...
	$sqlZ = "INSERT INTO CAT_CONTENIDO(ID_SUBMENU,UBICACION_LOCAL,UBICACION_REMOTA,DESCRIPCION,ORDEN)
             VALUES ('".$_GET['id_menu']."','/USUARIO1/','http://movi.2gps.net/".($utl)."/". str_replace(" ","_",$_FILES['archivo']['name'])."','".$tipo_archivo."','".$row_mayor['MAXIMO']."')";
