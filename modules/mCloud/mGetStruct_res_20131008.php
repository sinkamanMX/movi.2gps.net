 ...
 // echo $file ." cas $file\n"; //de ser un directorio lo envolvemos entre corchetes
					...
					if($file!='.' && $file!='..' ){
						...
						$divide2=explode('.',$file);
							...
							$cads.='<li><span  class="'.$divide[1].'"  onmouseup="muestra_deta(\''.$mmn.'\'),change_del(\''.$mmn.'\'),change_id(\''. 
							base64_encode($directorio.'/'.$file).'\')">'.$file . "-4</span></li>";
										$countar=$countar+1;
									}else{
							...
							$cads.='<li><span  class="file"  onmouseup="muestra_deta(\''.$mmn.'\'),change_del(\''.$mmn.'\'),change_id(\''. 
							base64_encode($directorio.'/'.$file).'\')">'.$file . "-5</span></li>";
			  							}
			 						}
							}
     				 //  echo $file ."$file\n";
