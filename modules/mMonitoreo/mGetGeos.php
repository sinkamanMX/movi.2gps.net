...
**/
	...
	*/
	$sql = "SELECT ID_OBJECT_MAP AS ID, TIPO,ADM_GEOREFERENCIAS.DESCRIPCION AS NOMBRE, PRIVACIDAD, 
					LATITUDE,LONGITUDE,IF(COD_COLOR IS NULL, '0',COD_COLOR) AS COD_COLOR,
					IF(ADM_GEOREFERENCIAS_TIPO.IMAGE IS NULL,'null',ADM_GEOREFERENCIAS_TIPO.IMAGE) AS IMAGE
