...
*/
	...
	$nombre=$manejar[0];
	$numst=$Positions-> prob_nom($idCompany ,$nombre);	
	if($numst==0){
	$active=$manejar[1];
	...
	if($ti_g[1]=='1'){
	 ...
	 $lasq="INSERT ALERT_MASTER VALUE (0,'".$nombre."',".$idCompany.",".$userID.",0,".$lun.",".$mar.",".$mier.",".$jue.",".$vier.",".$sab.",".$dom.",'".$horini."','".$horfin."','".$correo."',".$active.",0,0,CURRENT_TIMESTAMP,'".$cad_vari."',0,'',0,'".$tipo_geo."',0,'','','','')";
