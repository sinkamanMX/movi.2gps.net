...
$(document).ready(function () {
  ...
  $( "#pro_dialog_nvo" ).dialog({
    ...
    title:"Nuevo",
    modal: true,
    position: { my: "center", at: "top", of: '#Admon' },
    buttons: {
    Cancelar: function() {
...
function pro_load_datatable(){
    oTable = $('#pro_table').dataTable({
      ...
      "bAutoWidth": false,
      "bSortClasses": false,
    "sAjaxSource": "index.php?m=mPerfiles&c=mGetTable",
      "aoColumns": [
  ...
  function pro_edit_function(value){
      $.ajax({
          url: "index.php?m=mPerfiles&c=mGetPerfil",
          type: "GET",
          data: { data: value },
  ...
  function pro_send_row(){
      $.ajax({
          url: "index.php?m=mPerfiles&c=mSetPerfil",
          type: "GET",
          dataType : 'json',
          data: { 
