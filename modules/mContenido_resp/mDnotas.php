...
$db = new sql($config_bd['host'],$config_bd['port'],$config_bd['bname'],$config_bd['user'],$config_bd['pass']);
 ...
 $tpl->set_filenames(array('mDnotas' => 'tDnotas'));
...
//if ($row['TYPE']=='AVL'){
$sql_f="SELECT D.COMENTARIOS, D.FECHA,T.DESCRIPCION AS TNT, U.NOMBRE_COMPLETO FROM DSP_INCIDENCIA_ITINERARIO D
