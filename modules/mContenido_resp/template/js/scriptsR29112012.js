...
//barra_progress();
	var ajax = nuevoAjax();
		ajax.open("GET", "index.php?m=mContenido&c=mDatac&cto="+x+"&idd="+y,true);
		ajax.onreadystatechange=function() {
		if (ajax.readyState==4) {
				var result =ajax.responseText;
				//alert(result);
...
//alert($('#ptoso').val());
 var ajax = nuevoAjax();
 ajax.open("GET", "index.php?m=mContenido&c=mDatac&punto="+ptoso+"&cto="+y+"&idd="+z,true);
 ajax.onreadystatechange=function() {
  	 if (ajax.readyState==4) {
...
for(x=0; x<$('#cnt').val(); x++){
	...
	if(datap==""){
		datap=$('#pto'+x).val()+"¬"+$('#dt'+x).val()+" "+$('#hr'+x).val()+":"+$('#mn'+x).val()+":00"+"¬"+$('#obs'+x).val()+"¬"+$('#itm'+x).val()+"¬"+$('#cst'+x).val();
		}
	else{
		datap=datap+"~"+$('#pto'+x).val()+"¬"+$('#dt'+x).val()+" "+$('#hr'+x).val()+":"+$('#mn'+x).val()+":00"+"¬"+$('#obs'+x).val()+"¬"+$('#itm'+x).val()+"¬"+$('#cst'+x).val();
		}	
		//alert($('#itm'+x).val())
	}	
...
function grafix_detalle(unidad){
	...
	var ajax = nuevoAjax();
 ajax.open("GET", "index.php?m=mContenido&c=mGraficas_detalles&unidad="+unidad+"&cod_cli="+cod_cli,true);
 ajax.onreadystatechange=function() {
  	 if (ajax.readyState==4) {
		 destino.innerHTML = ajax.responseText;	
