...
INNER JOIN SAVL1220_G G ON G.ID_GROUP = GD.ID_GROUP
WHERE G.COD_CLIENT=".$idc."
AND (D.ID_ESTATUS=2 OR D.ID_ESTATUS=1 OR D.ID_ESTATUS=4) AND NOW() < DATE_ADD(D.FECHA_ENTREGA, INTERVAL DE.TOLERANCIA MINUTE)  AND D.ID_DESPACHO=".$_GET['idd'];
