...
function eqp_load_datatable(){
    ...
    oTable = $('#eqp_table').dataTable({
      ...
      "bAutoWidth": false,
      "bSortClasses": false,
      "sAjaxSource": "index.php?m=mUnidades&c=mEquipo",
      "aoColumns": [
...
function eqp_tpl_nuevo(){
      $.ajax({
          url: "index.php?m=mUnidades&c=mAddEquipo",
          type: "GET",
          data: {  },
...
function eqp_edit_function(value){
	//alert("value");
      $.ajax({
          url: "index.php?m=mUnidades&c=mSetEquipo",
          type: "GET",
          data: { data: value },
          success: function(data) {
            var result = data; 
...
function eqp_guardar_cambio(){
	...
	//alert(s)	;	
      $.ajax({
          url: "index.php?m=mUnidades&c=mSaveSetEquipo",
          type: "GET",
          data: { 
...
function eqp_guardar_nvo(){
	...
	//alert(s)	;
      $.ajax({
          url: "index.php?m=mUnidades&c=mSaveAddEquipo",
          type: "GET",
          data: { 
