...
**/
	...
	$result = array();
	$sql = "SELECT R.ID_RES_CUESTIONARIO,R.FECHA,Q.DESCRIPCION AS QST,U.NOMBRE_COMPLETO,R.LATITUD,R.LONGITUD FROM ADM_GEOREFERENCIA_CUESTIONARIO GC
	INNER JOIN CRM2_RESPUESTAS R ON R.ID_CUESTIONARIO = GC.ID_CUESTIONARIO
	...
	WHERE GC.ID_OBJECT_MAP = ".$_GET['id']." AND U.ID_USUARIO IN(".$_GET['usr'].") 
