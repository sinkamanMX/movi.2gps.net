...
**/
	...
	*/
	$sql = "SELECT COD_EQUIPMENT AS ID ,ITEM_NUMBER AS ITEM ,PHONE AS PHONE,IMEI ,ADM_EQUIPOS_TIPO.DESCRIPTION AS TIPO
			FROM ADM_EQUIPOS
			INNER JOIN ADM_EQUIPOS_TIPO ON ADM_EQUIPOS_TIPO.COD_TYPE_EQUIPMENT = ADM_EQUIPOS.COD_TYPE_EQUIPMENT
