...
**/
	...
	$sqlx = "SELECT ID_IMG, CONCAT('<img src=\"public/images/',URL,'\" alt=\"',DESCRIPCION,'\" title=\"',DESCRIPCION,'\" height=\"32\" width=\"32\" />') AS IMG, IS_DEFAULT 
FROM ADM_IMAGE WHERE TIPO = 'RH' AND ID_CLIENTE = ".$client." ORDER BY IS_DEFAULT,DESCRIPCION;";
