...
if(!$userAdmin->u_logged()){
 ...
 $tpl->set_filenames(array('mQuery6' => 'tQuery6'));
 
	 
	
////////////////////////////////////////////////////////////////////////////
$sql_g="SELECT D.ID_ESTATUS,
IF(D.FECHA_ARRIBO = '0000-00-00 00:00:00',CURDATE(),CAST(D.FECHA_ARRIBO AS DATE))AS DTA, 
IF(D.FECHA_ARRIBO = '0000-00-00 00:00:00',CURTIME(),CAST(D.FECHA_ARRIBO AS TIME)) AS HDTA
