...
WHERE GD.ID_USUARIO=".$idc." AND CAST(D.FECHA_INICIO AS DATE) >= CURDATE() AND(D.DESCRIPCION LIKE '%".$_GET['txtfil']."%' OR UN.DESCRIPTION  LIKE '%".$_GET['txtfil']."%' OR D.ITEM_NUMBER LIKE '%".$_GET['txtfil']."%' OR D.FECHA_INICIO LIKE '%".$_GET['txtfil']."%' OR D.FECHA_FIN LIKE '%".$_GET['txtfil']."%'  OR D.TOLERANCIA LIKE '%".$_GET['txtfil']."%')  ORDER BY D.FECHA_INICIO DESC";		
...
INNER JOIN ADM_USUARIOS_GRUPOS GD ON GD.COD_ENTITY = UN.COD_ENTITY
INNER JOIN ADM_GRUPOS G ON G.ID_GRUPO = GD.ID_GRUPO
WHERE GD.ID_USUARIO=".$idc." AND CURDATE()<=D.FECHA_FIN  ORDER BY D.FECHA_INICIO DESC";
